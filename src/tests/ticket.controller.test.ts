...
describe("Ticket Controller", () => {
    describe("POST /tickets", () => {
        ...
        it("no debe crear ticket para usuario inexistente", async () => {
            ...
            expect(res.body && (res.body.message || res.body.error)).toBe("Usuario no existe");
        });
    });
    ...
    describe("PUT /tickets/:id", () => {
        ...
        it("no debe actualizar ticket inexistente", async () => {
            ...
            expect(res.status).toBe(404);
            expect(res.body && (res.body.message || res.body.error)).toBe("Ticket no existe");
        });
    });
    ...
    describe("DELETE /tickets/:id", () => {
        it("debe eliminar un ticket existente", async () => {
            ...
            expect(res.status).toBe(200);
            expect(res.body && (res.body.message || res.body.result)).toBe("Eliminado");
        });
