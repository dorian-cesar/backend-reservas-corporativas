...
router.get("/verificar", authenticateJWT, checkPermission("pasajeros_ver_informacion_de_pasajeros", "buscar_generar_buequeda_de_servicios", "reservas_ver_informacion_de_reservas"), verificarPasajeroExistente);
router.get("/:id", authenticateJWT, checkPermission("pasajeros_ver_informacion_de_pasajeros"), getPasajeroById);
router.post("/", authenticateJWT, checkPermission("pasajeros_crear_nuevo_pasajero", "buscar_generar_buequeda_de_servicios", "reservas_ver_informacion_de_reservas"), createPasajero);
