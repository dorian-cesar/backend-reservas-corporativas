...
<span style="font-size:15px;font-weight:700;color:#fff;">ESTADO DE PAGO (EDP) � PER�ODO ${periodo}</span>
</td></tr>
<tr><td style="padding:32px;">
<p style="margin:0 0 24px;font-size:15px;color:#444;line-height:1.6;">Estimado(a),<br><br>
Adjunto encontrar� el <strong>Estado de Pago correspondiente al per�odo ${periodoReservas}</strong>
...
<table width="100%">
<tr><td style="font-size:13px;color:#555;padding:4px 0;width:45%;">Raz�n Social:</td><td style="font-size:13px;font-weight:700;color:#222;padding:4px 0;">${empresaNombre}</td></tr>
...
<tr><td style="font-size:13px;color:#555;padding:4px 0;">Per�odo:</td><td style="font-size:13px;font-weight:700;color:#222;padding:4px 0;">${periodoReservas}</td></tr>
<tr><td style="font-size:13px;color:#555;padding:4px 0;">Fecha Generaci�n:</td><td style="font-size:13px;font-weight:700;color:#222;padding:4px 0;">${fechaGeneracion}</td></tr>
</table></td></tr></table>
...
<strong>Pullman Bus � WIT Innovaci�n Tecnol�gica</strong><br>Este correo es generado autom�ticamente. Por favor no responda a esta direcci�n.</div>
</td></tr></table></td></tr></table></body></html>`;

  const msg: any = {
    to: validRecipients,
    from: 'viajes@pullmanbus.cl',
    subject: `Estado de Pago (EDP) � ${empresaNombre} � Per�odo ${periodo}`,
    html,
    attachments: [
  ...
  await sgMail.send(msg);
  console.log(`[EDP Mail] Enviado a: ${validRecipients.join(', ')} | Empresa: ${empresaNombre} | Per�odo: ${periodo}`);
};
